...
- [ ] Вынести генерацию негатива для вырезов посадочных мест под свитчи, сделать негатив под choc(или mx)
- [ ] Посадочные места под модульные PCB с хотсвап-сокетами

### Этап 5: Генерация через Go-шаблоны

- [ ] Исправление существующего примера конфигурации на основе scad эскиза
- [ ] Создание Go-шаблонов для генерации SCAD-файлов
- [ ] Интеграция шаблонов в команду `generate`
- [ ] Валидация конфигурации перед генерацией
- [ ] Поддержка генерации для левой и правой половин
